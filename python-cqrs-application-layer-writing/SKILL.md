...
11. Формируй самодостаточные неизменяемые version/outbox DTO в заданных точках
...
14. Не логируй в application-слое, включая use case, UoW и реализации портов,
