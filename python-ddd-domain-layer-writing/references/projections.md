...
Вызывающий application-код преобразует каждый случай в заданный публичный исход:
повтор версии, устаревшую версию или успех. Domain не логирует эти исходы.
