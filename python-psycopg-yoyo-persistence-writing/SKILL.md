...
- Добавлять приватные helpers для самостоятельной или повторяющейся технической
  логики; не создавать бессмысленные однострочные обёртки.
...
- Располагать публичные методы выше приватных.
...
- Не логировать пробрасываемую ошибку; итог логируется на входящей границе.
