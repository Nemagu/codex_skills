...
# Документирование PostgreSQL persistence-адаптера
...
разрешения пользователя. Найденное таким способом считать фактическим состоянием
или расхождением, но не нормативным требованием без подтверждения.

Различать:

- целевую схему по согласованным требованиям;
- фактическую схему по разрешённой сверке;
...
1. выбрать режим: целевая схема, разрешённая фактическая схема или сверка;
